...
DEFENSES=(none)  # BDs & DFL methods:  clip ubar median trim weakdp scclip krum abalance balance spp mmad flame deepsight dfldual
DATASETS=(gtsrb) #cifar10 mnist femnist gtsrb fashionmnist har 
